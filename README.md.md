...
\[Read the Full Report (PDF)](./Report\_FEniCSx\_FEM.pdf)
...
\- Constitutive Equations: Linear elasticity modeled via generalized Hooke's Law using Lamé parameters ($\\mu, \\lambda$).
